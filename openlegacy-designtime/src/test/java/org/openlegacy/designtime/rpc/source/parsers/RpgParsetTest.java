...
public class RpgParsetTest {
	...
	public void testRpgParsing() throws IOException, DesigntimeException {
		...
		rpgParser.setRpcName(sourceFile.substring(0, sourceFile.indexOf(".") > 0 ? sourceFile.indexOf(".") : sourceFile.length()));
